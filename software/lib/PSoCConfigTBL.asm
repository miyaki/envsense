...
export LoadConfigTBL_psocusb
AREA psoc_config(rom, rel)
LoadConfigTBL_psocusb:
;  Ordered Global Register values
	...
	M8C_SetBank1
	mov	reg[04h], 1dh		; Port_1_DriveMode_0 register (PRT1DM0)
	mov	reg[05h], f2h		; Port_1_DriveMode_1 register (PRT1DM1)
	M8C_SetBank0
	mov	reg[07h], e2h		; Port_1_DriveMode_2 register (PRT1DM2)
...
;  Global Register values
	mov	reg[60h], 0ah		; AnalogColumnInputSelect register (AMX_IN)
	mov	reg[66h], 00h		; AnalogComparatorControl1 register (CMP_CR1)
	mov	reg[61h], 00h		; AnalogMuxBusConfig register (AMUXCFG)
	mov	reg[63h], 15h		; AnalogReferenceControl register (ARF_CR)
...
;       Instance name ADCINC_1, Block Name ADC(ASC10)
	mov	reg[80h], 90h		;ADCINC_1_AtoDcr0(ASC10CR0)
	mov	reg[81h], 00h		;ADCINC_1_AtoDcr1(ASC10CR1)
	mov	reg[82h], 60h		;ADCINC_1_AtoDcr2(ASC10CR2)
	mov	reg[83h], f0h		;ADCINC_1_AtoDcr3(ASC10CR3)
...
;  Instance name AMUX0, User Module AMUX4
...
;       Instance name Timer8_1, Block Name TIMER8(DBB01)
	mov	reg[27h], 04h		;Timer8_1_CONTROL_REG(DBB01CR0)
	mov	reg[25h], ffh		;Timer8_1_PERIOD_REG(DBB01DR1)
	mov	reg[26h], 00h		;Timer8_1_COMPARE_REG(DBB01DR2)
;  Instance name USBUART_1, User Module USBUART
	M8C_SetBank1
;  Global Register values
	mov	reg[61h], 00h		; AnalogClockSelect1 register (CLK_CR1)
	mov	reg[69h], 00h		; AnalogClockSelect2 register (CLK_CR2)
	mov	reg[60h], 05h		; AnalogColumnClockSelect register (CLK_CR0)
	...
	mov	reg[e1h], f7h		; OscillatorControl_1 register (OSC_CR1)
	...
	mov	reg[e7h], 48h		; Type2Decimator_Control register (DEC_CR2)
	mov	reg[c1h], 00h		; USBControl_1 register (USB_CR1)
;  Instance name ADCINC_1, User Module ADCINC
;       Instance name ADCINC_1, Block Name ADC(ASC10)
;       Instance name ADCINC_1, Block Name PWM(DBB00)
	mov	reg[20h], 31h		;ADCINC_1_PWMfn(DBB00FN)
	mov	reg[21h], 16h		;ADCINC_1_PWMsl(DBB00IN)
...
;  Instance name Timer8_1, User Module Timer8
;       Instance name Timer8_1, Block Name TIMER8(DBB01)
	mov	reg[24h], 20h		;Timer8_1_FUNC_REG(DBB01FN)
	mov	reg[25h], 01h		;Timer8_1_INPUT_REG(DBB01IN)
	mov	reg[26h], 40h		;Timer8_1_OUTPUT_REG(DBB01OU)
;  Instance name USBUART_1, User Module USBUART
	M8C_SetBank0
	ret
