...
EXPORT USBUART_1_EPDataToggle, _USBUART_1_EPDataToggle
 ...
 USBUART_1_EP0DataToggle:               BLK   USB_NUM_ENDPOINTS
;----------------------------------------------------------------------------
...
USBUART_1_EP0_UPD_MODE_EXIT:
    ...
    MOV    REG[USBUART_1_EP0CNT], A    ; Update the count
    MOV    A, X                        ; Get the new mode
    MOV    REG[USBUART_1_EP0MODE], A   ; Update the node
...
USBUART_1_EP0_ISR_EXIT:
    ...
    REG_RESTORE MVW_PP
    POP  X                              ;
;       MOV  A, [USBUART_1_TempMode]
;       MOV  reg[USBUART_1_EP0MODE], A
...
;    CALL USBUART_1_ControlInDispatch
;    JMP  USBUART_1_EP0_ISR_EXIT             ; And exit
