...
_ADCINC_1_SetPower:
   ...
   push A
   mov  A,reg[ADCINC_1_AtoDcr3]                  ; First SC block:
   and  A,~03h                                   ;   clear power bits to zero
   or   A,[ X ]                                  ;   establish new value
   mov  reg[ADCINC_1_AtoDcr3],A                  ;   change the actual setting
   pop  A
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: ADCINC_1_StopADC
;
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: ADCINC_1_fClearFlag
;
