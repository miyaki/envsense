...
export LoadConfig_psocusb
export _LoadConfig_psocusb
...
;---------------------------------------------------------------------------
; Load Configuration psocusb
;
;    Load configuration registers for psocusb.
...
_LoadConfig_psocusb:
 LoadConfig_psocusb:
    RAM_PROLOGUE RAM_USE_CLASS_4
    lcall   LoadConfigTBL_psocusb            ; Call load config table routine
