...
;-----------------------------------------------------------------------------
;  FUNCTION NAME: USBUART_1_Not_Supported
;
;  DESCRIPTION:
;
;-----------------------------------------------------------------------------
...
export  USBUART_1_CB_d2h_std_dev_00
USBUART_1_CB_d2h_std_dev_00:
ENDIF
IF (USB_CB_SRC_d2h_std_dev_01 & USB_NOT_SUPPORTED)
export  USBUART_1_CB_d2h_std_dev_01
USBUART_1_CB_d2h_std_dev_01:
ENDIF
IF (USB_CB_SRC_d2h_std_dev_02 & USB_NOT_SUPPORTED)
export  USBUART_1_CB_d2h_std_dev_02
USBUART_1_CB_d2h_std_dev_02:
ENDIF
IF (USB_CB_SRC_d2h_std_dev_03 & USB_NOT_SUPPORTED)
export  USBUART_1_CB_d2h_std_dev_03
USBUART_1_CB_d2h_std_dev_03:
ENDIF
IF (USB_CB_SRC_d2h_std_dev_04 & USB_NOT_SUPPORTED)
export  USBUART_1_CB_d2h_std_dev_04
USBUART_1_CB_d2h_std_dev_04:
ENDIF
IF (USB_CB_SRC_d2h_std_dev_05 & USB_NOT_SUPPORTED)
export  USBUART_1_CB_d2h_std_dev_05
USBUART_1_CB_d2h_std_dev_05:
ENDIF
IF (USB_CB_SRC_d2h_std_dev_06 & USB_NOT_SUPPORTED)
export  USBUART_1_CB_d2h_std_dev_06
USBUART_1_CB_d2h_std_dev_06:
ENDIF
IF (USB_CB_SRC_d2h_std_dev_07 & USB_NOT_SUPPORTED)
export  USBUART_1_CB_d2h_std_dev_07
USBUART_1_CB_d2h_std_dev_07:
ENDIF
IF (USB_CB_SRC_d2h_std_dev_08 & USB_NOT_SUPPORTED)
export  USBUART_1_CB_d2h_std_dev_08
USBUART_1_CB_d2h_std_dev_08:
ENDIF

; h2d_std_dev
IF (USB_CB_SRC_h2d_std_dev_00 & USB_NOT_SUPPORTED)
export  USBUART_1_CB_h2d_std_dev_00
USBUART_1_CB_h2d_std_dev_00:
ENDIF
IF (USB_CB_SRC_h2d_std_dev_01 & USB_NOT_SUPPORTED)
export  USBUART_1_CB_h2d_std_dev_01
USBUART_1_CB_h2d_std_dev_01:
ENDIF
IF (USB_CB_SRC_h2d_std_dev_02 & USB_NOT_SUPPORTED)
export  USBUART_1_CB_h2d_std_dev_02
USBUART_1_CB_h2d_std_dev_02:
ENDIF
IF (USB_CB_SRC_h2d_std_dev_03 & USB_NOT_SUPPORTED)
export  USBUART_1_CB_h2d_std_dev_03
USBUART_1_CB_h2d_std_dev_03:
ENDIF
IF (USB_CB_SRC_h2d_std_dev_04 & USB_NOT_SUPPORTED)
export  USBUART_1_CB_h2d_std_dev_04
USBUART_1_CB_h2d_std_dev_04:
ENDIF
IF (USB_CB_SRC_h2d_std_dev_05 & USB_NOT_SUPPORTED)
export  USBUART_1_CB_h2d_std_dev_05
USBUART_1_CB_h2d_std_dev_05:
ENDIF
IF (USB_CB_SRC_h2d_std_dev_06 & USB_NOT_SUPPORTED)
export  USBUART_1_CB_h2d_std_dev_06
USBUART_1_CB_h2d_std_dev_06:
ENDIF
IF (USB_CB_SRC_h2d_std_dev_07 & USB_NOT_SUPPORTED)
export  USBUART_1_CB_h2d_std_dev_07
USBUART_1_CB_h2d_std_dev_07:
ENDIF
IF (USB_CB_SRC_h2d_std_dev_08 & USB_NOT_SUPPORTED)
export  USBUART_1_CB_h2d_std_dev_08
USBUART_1_CB_h2d_std_dev_08:
ENDIF
IF (USB_CB_SRC_h2d_std_dev_09 & USB_NOT_SUPPORTED)
export  USBUART_1_CB_h2d_std_dev_09
USBUART_1_CB_h2d_std_dev_09:
ENDIF

; d2h_std_ifc
IF (USB_CB_SRC_d2h_std_ifc_00 & USB_NOT_SUPPORTED)
export  USBUART_1_CB_d2h_std_ifc_00
USBUART_1_CB_d2h_std_ifc_00:
ENDIF
IF (USB_CB_SRC_d2h_std_ifc_01 & USB_NOT_SUPPORTED)
export  USBUART_1_CB_d2h_std_ifc_01
USBUART_1_CB_d2h_std_ifc_01:
ENDIF
IF (USB_CB_SRC_d2h_std_ifc_02 & USB_NOT_SUPPORTED)
export  USBUART_1_CB_d2h_std_ifc_02
USBUART_1_CB_d2h_std_ifc_02:
ENDIF
IF (USB_CB_SRC_d2h_std_ifc_03 & USB_NOT_SUPPORTED)
export  USBUART_1_CB_d2h_std_ifc_03
USBUART_1_CB_d2h_std_ifc_03:
ENDIF
IF (USB_CB_SRC_d2h_std_ifc_04 & USB_NOT_SUPPORTED)
export  USBUART_1_CB_d2h_std_ifc_04
USBUART_1_CB_d2h_std_ifc_04:
ENDIF
IF (USB_CB_SRC_d2h_std_ifc_05 & USB_NOT_SUPPORTED)
export  USBUART_1_CB_d2h_std_ifc_05
USBUART_1_CB_d2h_std_ifc_05:
ENDIF
IF (USB_CB_SRC_d2h_std_ifc_06 & USB_NOT_SUPPORTED)
export  USBUART_1_CB_d2h_std_ifc_06
USBUART_1_CB_d2h_std_ifc_06:
ENDIF
IF (USB_CB_SRC_d2h_std_ifc_07 & USB_NOT_SUPPORTED)
export  USBUART_1_CB_d2h_std_ifc_07
USBUART_1_CB_d2h_std_ifc_07:
ENDIF
IF (USB_CB_SRC_d2h_std_ifc_08 & USB_NOT_SUPPORTED)
export  USBUART_1_CB_d2h_std_ifc_08
USBUART_1_CB_d2h_std_ifc_08:
ENDIF
IF (USB_CB_SRC_d2h_std_ifc_09 & USB_NOT_SUPPORTED)
export  USBUART_1_CB_d2h_std_ifc_09
USBUART_1_CB_d2h_std_ifc_09:
ENDIF
IF (USB_CB_SRC_d2h_std_ifc_10 & USB_NOT_SUPPORTED)
export  USBUART_1_CB_d2h_std_ifc_10
USBUART_1_CB_d2h_std_ifc_10:
ENDIF

; d2h_std_ifc
IF (USB_CB_SRC_h2d_std_ifc_00 & USB_NOT_SUPPORTED)
export  USBUART_1_CB_h2d_std_ifc_00
USBUART_1_CB_h2d_std_ifc_00:
ENDIF

; d2h_std_ep
IF (USB_CB_SRC_d2h_std_ep_00 & USB_NOT_SUPPORTED)
export  USBUART_1_CB_d2h_std_ep_00
USBUART_1_CB_d2h_std_ep_00:
ENDIF

; h2d_std_ep
IF (USB_CB_SRC_h2d_std_ep_00 & USB_NOT_SUPPORTED)
export  USBUART_1_CB_h2d_std_ep_00
USBUART_1_CB_h2d_std_ep_00:
ENDIF
IF (USB_CB_SRC_h2d_std_ep_01 & USB_NOT_SUPPORTED)
export  USBUART_1_CB_h2d_std_ep_01
USBUART_1_CB_h2d_std_ep_01:
ENDIF
IF (USB_CB_SRC_h2d_std_ep_02 & USB_NOT_SUPPORTED)
export  USBUART_1_CB_h2d_std_ep_02
USBUART_1_CB_h2d_std_ep_02:
ENDIF
IF (USB_CB_SRC_h2d_std_ep_03 & USB_NOT_SUPPORTED)
export  USBUART_1_CB_h2d_std_ep_03
USBUART_1_CB_h2d_std_ep_03:
ENDIF

export  USBUART_1_Not_Supported
export _USBUART_1_Not_Supported
USBUART_1_Not_Supported:
_USBUART_1_Not_Supported:
   MOV    A, 0                         ; Count 0
   MOV    X, USB_MODE_STALL_IN_OUT     ; Stall the request
   LJMP   USBUART_1_EP0_UPD_MODE_EXIT
;-----------------------------------------------------------------------------
;  FUNCTION NAME: USBUART_1_CB_d2h_std_dev_00
;
...
GetStatusTransferDescrTable:
    ...
    TD_ENTRY    USB_DS_RAM, 2, USBUART_1_TransferBuffer, NULL_PTR  ; Intermediate Buffer
.ENDLITERAL
export  USBUART_1_CB_d2h_std_dev_00
USBUART_1_CB_d2h_std_dev_00:
    MOV     [USBUART_1_t2], 0          ; Use the UM temp var--Selector

    MOV     [USBUART_1_TransferBuffer+1], 0  ; Use the UM Transfer Buffer
    MOV     [USBUART_1_TransferBuffer], [USBUART_1_DeviceStatus]

    MOV     A,>GetStatusTransferDescrTable  ; Get the ROM Address MSB
    MOV     X,<GetStatusTransferDescrTable  ; Get the ROM Address LSB
    JMP     USBUART_1_GetTableEntry_Local_Std
ENDIF
;-----------------------------------------------------------------------------
; FUNCTION NAME: USBUART_1_CB_d2h_std_dev_06
;
...
;-----------------------------------------------------------------------------
    MOV     A, REG[USBUART_1_EP0DATA+wValueHi] ; Get the descriptor type
    ASL     A                          ; Make it into a offset
    CMP     A, GET_DESCR_DISPATCH_SIZE         ; Validity check
    JNC     USBUART_1_Not_Supported

    JACC    GET_DESCR_DISPATCH

GET_DESCR_DISPATCH:
    JMP     USBUART_1_Not_Supported    ; Invalid
    JMP     USBUART_1_SendDeviceDescr  ; Device Descriptor
    JMP     USBUART_1_SendConfigDescr  ; Configuration Descriptor
IF  USBUART_1_bNumStringDescrs         ; Number of String Descriptor defined with the Wizard
    JMP     USBUART_1_SendStringDescr  ; String Descriptor
ELSE
    JMP     USBUART_1_Not_Supported    ; Not supported if we don't have
...
;-----------------------------------------------------------------------------
USBUART_1_SendConfigDescr:
    CALL    USBUART_1_GET_DEVICE_TABLE_ENTRY
    SWAP    A, X
    ADD     A, 2                       ; We want the pointer to the descriptor table (second entry)
    SWAP    A, X
    ADC     A, 0                       ; Don't forget the carry
    MOV    [USBUART_1_t2], USBUART_1_t1; Set up the destination  
    CALL    USBUART_1_GETWORD          ; Get the pointer
    
    MOV     A, [USBUART_1_t1]          ; Pointer MSB
    MOV     X, [USBUART_1_t1+1]        ; Pointer LSB
    
    PUSH    A                          ; Save the MSB
    
    MOV     A, REG[USBUART_1_EP0DATA+wValueLo]  ; Get the descriptor index
    MOV     [USBUART_1_t2], A          ; Use the UM temp var--Selector
...
;-----------------------------------------------------------------------------
USBUART_1_SendDeviceDescr:
    MOV     [USBUART_1_t2], [USBUART_1_bCurrentDevice]  ; Use the UM temp var--Selector
    MOV     A,>USBUART_1_DEVICE_DESCR_TABLE  ; Get the ROM Address MSB
    MOV     X,<USBUART_1_DEVICE_DESCR_TABLE  ; Get the ROM Address LSB
    ROMX                               ; First entry is the table size (only a byte)
    CMP     A, [USBUART_1_t2]          ; Range check
    JC      USBUART_1_Not_Supported
...
;-----------------------------------------------------------------------------
IF  USBUART_1_bNumStringDescrs    ; Not needed if we don't have any String Descriptors
USBUART_1_SendStringDescr:
    MOV     A, REG[USBUART_1_EP0DATA+wValueLo]  ; Get the descriptor index
    MOV     [USBUART_1_t2], A          ; Use the UM temp var--Selector

    MOV     A,>USBUART_1_StringTable   ; Get the ROM Address MSB
    MOV     X,<USBUART_1_StringTable   ; Get the ROM Address LSB
    ROMX                               ; First entry is the table size (only a byte)
    CMP     A, [USBUART_1_t2]          ; Range check
    JC      USBUART_1_Not_Supported
...
ENDIF
;-----------------------------------------------------------------------------
;  FUNCTION NAME: USBUART_1_CB_d2h_std_dev_08
;
...
GetConfigTransferDescrTable:
    TD_START_TABLE  1                  ; One entry
    TD_ENTRY    USB_DS_RAM, 1, USBUART_1_Configuration, NULL_PTR  ; Current configuration
.ENDLITERAL
export  USBUART_1_CB_d2h_std_dev_08
USBUART_1_CB_d2h_std_dev_08:
    MOV     [USBUART_1_t2], 0          ; Use the UM temp var--Selector
...
ENDIF
;-----------------------------------------------------------------------------
;  FUNCTION NAME: USBUART_1_CB_h2d_std_dev_01
;
...
export  USBUART_1_CB_h2d_std_dev_01
USBUART_1_CB_h2d_std_dev_01:
    MOV     A, REG[USBUART_1_EP0DATA+wValueLo]  ; Get the Feature Selector
                                       ; Check against valid features
                                       ;  for device recipient
    CMP     A, USB_DEVICE_REMOTE_WAKEUP  ; Only remote wakeup is defined for clear
    JNZ     USBUART_1_Not_Supported    ;      
    AND     [USBUART_1_DeviceStatus], ~USB_DEVICE_STATUS_REMOTE_WAKEUP
    JMP     USBUART_1_NoDataStageControlTransfer_Local_Std
ENDIF
;-----------------------------------------------------------------------------
;  FUNCTION NAME: USBUART_1_CB_h2d_std_dev_03
;
...
.remote_wakeup:
    OR      [USBUART_1_DeviceStatus], USB_DEVICE_STATUS_REMOTE_WAKEUP
    JMP     .finish
...
ENDIF
;-----------------------------------------------------------------------------
;  FUNCTION NAME: USBUART_1_CB_h2d_std_dev_05
;
...
USBUART_1_CB_h2d_std_dev_05:
    ...
    MOV     [USBUART_1_fDataPending], USB_ADDRESS_CHANGE_PENDING       
    MOV     A, REG[USBUART_1_EP0DATA+wValueLo]       
    MOV     [USBUART_1_TransferBuffer],A       
...
;-----------------------------------------------------------------------------
;  FUNCTION NAME: USBUART_1_CB_h2d_std_dev_09
;
...
; Refactored from the two loops below
    MOV     [USBUART_1_Configuration],[USBUART_1_t2]  ; Save the config number

    CMP     [USBUART_1_t2], 0          ; Unconfigure?
    JZ      .unconfigure
...
.configure_next:
    ...
    MOV     X, [USBUART_1_t1+1]        ; Get the CONFIG_LOOKUP ROM Address LSB
    ROMX
    INC     [USBUART_1_t1+1]           ; Point to the next 
    ADC     [USBUART_1_t1], 0          ;
    POP     X
...
.unconfigure_next:
    MOV     [X+USBUART_1_EndpointAPIStatus], NO_EVENT_ALLOWED ; For the API
    MOV     REG[X+USBUART_1_EP1MODE-1], USB_MODE_DISABLE ; Disable the endpoint
    DEC     X                          ; One more down
...
;-----------------------------------------------------------------------------
;  FUNCTION NAME: USBUART_1_CB_d2h_std_ifc_00
;
...
GetInterfaceStatusTransferDescrTable:
    TD_START_TABLE  1                  ; One entry
    TD_ENTRY        USB_DS_RAM, 2, USBUART_1_TransferBuffer, NULL_PTR  ; Reuse the transfer buffer
.ENDLITERAL
export  USBUART_1_CB_d2h_std_ifc_00
USBUART_1_CB_d2h_std_ifc_00:

    MOV     [USBUART_1_TransferBuffer], 0     ; Zero the transfer buffer
    MOV     [USBUART_1_TransferBuffer+1], 0  ; 
...
ENDIF
;-----------------------------------------------------------------------------
;  FUNCTION NAME: USBUART_1_CB_d2h_std_ifc_10
;
...
GetInterfaceTransferDescrTable:
    TD_START_TABLE  1                  ; One entry
    TD_ENTRY        USB_DS_RAM, 1, USBUART_1_TransferBuffer, NULL_PTR  ; Reuse the transfer buffer
.ENDLITERAL
export  USBUART_1_CB_d2h_std_ifc_10
USBUART_1_CB_d2h_std_ifc_10:
    MOV     A, REG[USBUART_1_EP0DATA+wIndexLo]  ; Get the interface number
    ...
    MOV     A, [X + USBUART_1_InterfaceSetting]  ; Save the current interface setting
    MOV     [USBUART_1_TransferBuffer], A     ; into the transfer buffer
...
;-----------------------------------------------------------------------------
;  FUNCTION NAME: USBUART_1_CB_d2h_std_ep_00
;
...
export  USBUART_1_CB_d2h_std_ep_00
USBUART_1_CB_d2h_std_ep_00:
    MOV     A, REG[USBUART_1_EP0DATA+wIndexLo]  ; Get the endpoint number
    ...
    MOV     [USBUART_1_TransferBuffer + 1], 0  ; Use the UM Transfer Buffer
    MOV     A, [X + USBUART_1_EndpointStatus]  ; Get the status
    MOV     [USBUART_1_TransferBuffer], A  ; Save it in the report
...
;-----------------------------------------------------------------------------
;  FUNCTION NAME: USBUART_1_CB_h2d_std_ep_01
;
...
USBUART_1_CB_h2d_std_ep_01:
    ...
    AND     [X+USBUART_1_EndpointStatus], ~USB_ENDPOINT_STATUS_HALT  ; Clear the endpoint halt

    TST     REG[USBUART_1_EP0DATA+wIndexLo], USB_DIR_IN  ; IN or OUT endpoint?
    M8C_SetBank1	                      ; For EP1_MODE register
    JNZ     .in

    MOV     REG[X + USBUART_1_EP1MODE - 1], USB_MODE_NAK_OUT  ; NAK the endpoint
    JMP     .done    
.in:
    MOV     REG[X + USBUART_1_EP1MODE - 1], USB_MODE_NAK_IN  ; NAK the endpoint
.done:
	M8C_SetBank0
    JMP     USBUART_1_NoDataStageControlTransfer_Local_Std
ENDIF
;-----------------------------------------------------------------------------
;  FUNCTION NAME: USBUART_1_CB_h2d_std_ep_03
;
...
USBUART_1_CB_h2d_std_ep_03:
    ...
    OR      [X+USBUART_1_EndpointStatus], USB_ENDPOINT_STATUS_HALT  ; Halt the endpoint

    TST     REG[USBUART_1_EP0DATA+wIndexLo], USB_DIR_IN  ; IN or OUT endpoint?
    M8C_SetBank1	                      ; For EP1_MODE register
    JNZ     .in

    MOV     REG[X + USBUART_1_EP1MODE - 1], USB_MODE_STALL_DATA_EP | USB_MODE_ACK_OUT  ; Stall the endpoint
    JMP     .done    
.in:
    MOV     REG[X + USBUART_1_EP1MODE - 1], USB_MODE_STALL_DATA_EP | USB_MODE_ACK_IN  ; Stall the endpoint
.done:        
	M8C_SetBank0
    JMP     USBUART_1_NoDataStageControlTransfer_Local_Std
ENDIF
...
;    JMP   .exit2
    JMP   .cont
.EP1IntEnable:
    M8C_EnableIntMask USBUART_1_INT_REG, USBUART_1_INT_EP1_MASK
    JMP   .cont
.EP2IntEnable:
    M8C_EnableIntMask USBUART_1_INT_REG, USBUART_1_INT_EP2_MASK
    JMP   .cont
.EP3IntEnable:
    M8C_EnableIntMask USBUART_1_INT_REG, USBUART_1_INT_EP3_MASK
    JMP   .cont
.EP4IntEnable:
    M8C_EnableIntMask USBUART_1_INT_REG, USBUART_1_INT_EP4_MASK  
	JMP   .cont
...
;    MOV   [USBUART_1_TempMode], USB_MODE_NAK_OUT ; NAK the endpoint
;    JMP   .exit2
; Jump here for an IN Endpoint
;.inEP0:
;    MOV   [USBUART_1_TempMode], USB_MODE_NAK_IN ; NAK the endpoint
;	JMP   .exit2
.cont:
    MOV     A, X	                      ; Get the endpoint number from X
    INDEX   USBUART_1_USB_EP_BIT_LOOKUP	 ; Find bit position for endpoint
    XOR     A, FFh
    AND     [USBUART_1_EPDataToggle], A ; Clear the data toggle for this endpoint
...
; Flow here for an OUT Endpoint
    MOV   REG[X+USBUART_1_EP1MODE-1], USB_MODE_NAK_OUT ; NAK the endpoint
    MOV   [X+USBUART_1_EndpointAPIStatus], NO_EVENT_PENDING ; For the API
    JMP   .exit1
; Jump here for an IN Endpoint
.in:
    MOV   REG[X+USBUART_1_EP1MODE-1], USB_MODE_NAK_IN ; NAK the endpoint
    MOV   [X+USBUART_1_EndpointAPIStatus], EVENT_PENDING ; For the API
; Jump or flow here to set the API event and exit    
.exit1:
	M8C_SetBank0
.exit2:
;    MOV   [X+USBUART_1_EPDataToggle], 0  ; Clear all EP data toggles?  Is this right?
    RET
...
;
;-----------------------------------------------------------------------------
USBUART_1_DT_d2h_std_dev:
;-----------------------------------------------------------------------------

    jmp     USBUART_1_CB_d2h_std_dev_00
    jmp     USBUART_1_CB_d2h_std_dev_01
    jmp     USBUART_1_CB_d2h_std_dev_02
    jmp     USBUART_1_CB_d2h_std_dev_03
    jmp     USBUART_1_CB_d2h_std_dev_04
    jmp     USBUART_1_CB_d2h_std_dev_05
    jmp     USBUART_1_CB_d2h_std_dev_06
    jmp     USBUART_1_CB_d2h_std_dev_07
    jmp     USBUART_1_CB_d2h_std_dev_08

USBUART_1_DT_d2h_std_dev_End:
USBUART_1_DT_d2h_std_dev_Size: equ (USBUART_1_DT_d2h_std_dev_End-USBUART_1_DT_d2h_std_dev) / 2
USBUART_1_DT_d2h_std_dev_Dispatch::
    MOV    A, REG[USBUART_1_EP0DATA + bRequest]
    DISPATCHER USBUART_1_DT_d2h_std_dev, USBUART_1_DT_d2h_std_dev_Size, USBUART_1_Not_Supported 

;-----------------------------------------------------------------------------
USBUART_1_DT_h2d_std_dev:
;-----------------------------------------------------------------------------

    jmp     USBUART_1_CB_h2d_std_dev_00
    jmp     USBUART_1_CB_h2d_std_dev_01
    jmp     USBUART_1_CB_h2d_std_dev_02
    jmp     USBUART_1_CB_h2d_std_dev_03
    jmp     USBUART_1_CB_h2d_std_dev_04
    jmp     USBUART_1_CB_h2d_std_dev_05
    jmp     USBUART_1_CB_h2d_std_dev_06
    jmp     USBUART_1_CB_h2d_std_dev_07
    jmp     USBUART_1_CB_h2d_std_dev_08
    jmp     USBUART_1_CB_h2d_std_dev_09

USBUART_1_DT_h2d_std_dev_End:
USBUART_1_DT_h2d_std_dev_Size: equ (USBUART_1_DT_h2d_std_dev_End-USBUART_1_DT_h2d_std_dev) / 2
USBUART_1_DT_h2d_std_dev_Dispatch::

    MOV     A, REG[USBUART_1_EP0DATA + bRequest]
    DISPATCHER USBUART_1_DT_h2d_std_dev, USBUART_1_DT_h2d_std_dev_Size, USBUART_1_Not_Supported 


;-----------------------------------------------------------------------------
USBUART_1_DT_d2h_std_ifc:
;-----------------------------------------------------------------------------

    jmp     USBUART_1_CB_d2h_std_ifc_00
    jmp     USBUART_1_CB_d2h_std_ifc_01
    jmp     USBUART_1_CB_d2h_std_ifc_02
    jmp     USBUART_1_CB_d2h_std_ifc_03
    jmp     USBUART_1_CB_d2h_std_ifc_04
    jmp     USBUART_1_CB_d2h_std_ifc_05
    jmp     USBUART_1_CB_d2h_std_ifc_06
    jmp     USBUART_1_CB_d2h_std_ifc_07
    jmp     USBUART_1_CB_d2h_std_ifc_08
    jmp     USBUART_1_CB_d2h_std_ifc_09
    jmp     USBUART_1_CB_d2h_std_ifc_10

USBUART_1_DT_d2h_std_ifc_End:
USBUART_1_DT_d2h_std_ifc_Size: equ (USBUART_1_DT_d2h_std_ifc_End-USBUART_1_DT_d2h_std_ifc) / 2
USBUART_1_DT_d2h_std_ifc_Dispatch::
    CMP     [USBUART_1_Configuration], 0  ; Is the device configured?
    JNZ     .configured                ; Jump on configured
    JMP    _USBUART_1_Not_Supported    ; Stall the request if not configured
; Jump here if the device is configured
.configured:
    MOV     A, REG[USBUART_1_EP0DATA + bRequest]
    DISPATCHER USBUART_1_DT_d2h_std_ifc, USBUART_1_DT_d2h_std_ifc_Size, USBUART_1_Not_Supported 

;-----------------------------------------------------------------------------
USBUART_1_DT_h2d_std_ifc:
;-----------------------------------------------------------------------------

    jmp     USBUART_1_CB_h2d_std_ifc_00

USBUART_1_DT_h2d_std_ifc_End:
USBUART_1_DT_h2d_std_ifc_Size: equ (USBUART_1_DT_h2d_std_ifc_End-USBUART_1_DT_h2d_std_ifc) / 2
USBUART_1_DT_h2d_std_ifc_Dispatch::
    CMP     [USBUART_1_Configuration], 0  ; Is the device configured?
    JNZ     .configured                ; Jump on configured
    JMP    _USBUART_1_Not_Supported    ; Stall the request if not configured
; Jump here if the device is configured
.configured:
    MOV     A, REG[USBUART_1_EP0DATA + bRequest]
    DISPATCHER USBUART_1_DT_h2d_std_ifc, USBUART_1_DT_h2d_std_ifc_Size, USBUART_1_Not_Supported 

;-----------------------------------------------------------------------------
USBUART_1_DT_d2h_std_ep:
;-----------------------------------------------------------------------------
    jmp     USBUART_1_CB_d2h_std_ep_00

USBUART_1_DT_d2h_std_ep_End:
USBUART_1_DT_d2h_std_ep_Size: equ (USBUART_1_DT_d2h_std_ep_End-USBUART_1_DT_d2h_std_ep) / 2
USBUART_1_DT_d2h_std_ep_Dispatch::
    CMP     [USBUART_1_Configuration], 0  ; Is the device configured?
    JNZ     .configured                ; Jump on configured

    MOV     A, REG[USBUART_1_EP0DATA + wIndexHi] ; Is the request for EP0?
    MOV     [USBUART_1_t2], A          ; Use the UM temp var--Selector
    MOV     A, REG[USBUART_1_EP0DATA + wIndexLo] ;
    OR      [USBUART_1_t2], A          ; Use the UM temp var--Selector
    JZ      .ep0_request
...
.ep0_request:
    MOV     A, REG[USBUART_1_EP0DATA + bRequest]
    DISPATCHER USBUART_1_DT_d2h_std_ep, USBUART_1_DT_d2h_std_ep_Size, USBUART_1_Not_Supported 


;-----------------------------------------------------------------------------
USBUART_1_DT_h2d_std_ep:
;-----------------------------------------------------------------------------
    jmp     USBUART_1_CB_h2d_std_ep_00
    jmp     USBUART_1_CB_h2d_std_ep_01
    jmp     USBUART_1_CB_h2d_std_ep_02
    jmp     USBUART_1_CB_h2d_std_ep_03

USBUART_1_DT_h2d_std_ep_End:
USBUART_1_DT_h2d_std_ep_Size: equ (USBUART_1_DT_h2d_std_ep_End-USBUART_1_DT_h2d_std_ep) / 2
USBUART_1_DT_h2d_std_ep_Dispatch::
    CMP     [USBUART_1_Configuration], 0  ; Is the device configured?
    JNZ     .configured                ; Jump on configured
...
.ep0_request:
    MOV     A, REG[USBUART_1_EP0DATA + bRequest]
    DISPATCHER USBUART_1_DT_h2d_std_ep, USBUART_1_DT_h2d_std_ep_Size, USBUART_1_Not_Supported 

USBUART_1_GetTableEntry_Local_Std:
    LJMP    USBUART_1_GetTableEntry

USBUART_1_NoDataStageControlTransfer_Local_Std:
    LJMP    USBUART_1_NoDataStageControlTransfer
